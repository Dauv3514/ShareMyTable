...
const EVENT_SECTIONS: EventSection[] = [
  {
    slug: "prochainement",
    title: "Prochainement",
    description: "Découvrez les prochains repas partagés",
  ...
  },
  {
    slug: "en-exterieur",
    title: "En extérieur",
    description: "Des repas conviviaux pour profiter des beaux jours",
  ...
  },
  {
    slug: "veggie",
    title: "Veggie",
    description: "Découvrez des repas maison végétariens",
  ...
  },
  {
    slug: "autour-de-moi",
    title: "Autour de moi",
    description: "Des repas conviviaux près de chez vous",
